      ...
      <div className="doc-layout">
        ...
        <div className="doc-body">
          <div className="content-shell">
            <article className="section-block" id="abstract">
              <h2>Abstract</h2>
              <SidenotePair
                noteId="sn-abstract-1"
                noteNumber={1}
                aside={
                  <>
                    Model organisms trade ecological validity for
                    measurability—much like small synthetic repos trade realism for
                    interpretable errors and ablations.
                  </>
                }
              >
                <p>
                  ...
                  <SidenoteRef noteId="sn-abstract-1" n={1} /> Donec accumsan enim
                  augue, a vulputate nisi sodales sit amet. Maecenas ac gravida
                  ante, nec cursus dui. Vivamus purus nibh, placerat ac purus
                  eget, sagittis vestibulum metus.
                </p>
                <p>
            ...
            <article className="section-block" id="motivation">
              ...
              <SidenotePair
                ...
                aside={
                  <>
                    Hover the bars below: tooltips summarize each metric slice
                    using D3-driven scales and transitions.
                  </>
                }
              >
                <p>
                  ...
                  <SidenoteRef noteId="sn-motivation-1" n={2} />
                </p>
                <p>
            ...
            <article className="section-block" id="plan">
              <h2>Plan</h2>
              <SidenotePair
                noteId="sn-plan-1"
                noteNumber={3}
                aside={
                  <>
                    The chart compares organism families by a composite utility
                    score (illustrative only).
                  </>
                }
              >
                <p>
                  ...
                  partial credit.
                  <SidenoteRef noteId="sn-plan-1" n={3} />
                </p>
                <p>
                  Excepteur sint occaecat cupidatat non proident, sunt in culpa
                  qui officia deserunt mollit anim id est laborum. Timelines and
            ...
            <article className="section-block" id="expected-results">
              <h2>Expected results</h2>
              <div className="section-main">
                <p>
                  We expect sharper attribution of model changes, reduced
                  variance across re-runs, and clearer error taxonomies.
                ...
                <div
                  ...
                  role="img"
                  aria-label="Result preview placeholder"
                >
          ...
          <footer className="site-footer" id="references">
            <div className="footer-inner">
              ...
              <div className="references">
                <ol>
                  <li>
                    Austin, J., et al. Program synthesis with large language
                    models.
